{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "print(\"Reading checkpoint 5...\")\n",
    "updated = pd.read_csv('checkpoint-5.csv')\n",
    "print(\"Finished reading checkpoint-5\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "11          4.1        -73.991601        40.744712         -73.983081   \n",
       "12          7.0        -74.005360        40.728867         -74.008913   \n",
       "13          7.7        -74.001821        40.737547         -73.998060   \n",
       "14         12.5        -73.986430        40.760465         -73.988990   \n",
       "15          5.3        -73.981060        40.737690         -73.994177   \n",
       "16          5.3        -73.969505        40.784843         -73.958732   \n",
       "17          4.0        -73.979815        40.751902         -73.979446   \n",
       "18         10.5        -73.985382        40.747858         -73.978377   \n",
       "19         11.5        -73.957954        40.779252         -73.961250   \n",
       "\n",
       "    dropoff_latitude  passenger_count      time  day  weekend  holiday  \\\n",
       "0          40.712278                1  17:26:21    0    False        0   \n",
       "1          40.782004                1  16:52:16    1    False        0   \n",
       "2          40.750562                2  00:35:00    3    False        0   \n",
       "3          40.758092                1  04:30:42    5     True        0   \n",
       "4          40.783762                1  07:51:00    1    False        0   \n",
       "5          40.758233                1  09:50:45    3    False        0   \n",
       "6          40.764842                1  20:35:00    1    False        0   \n",
       "7          40.751048                1  17:22:00    2    False        0   \n",
       "8          40.731628                1  13:10:00    0    False        0   \n",
       "9          40.758138                2  01:11:00    2    False        0   \n",
       "10         40.733559                1  07:30:50    6     True        0   \n",
       "11         40.744682                2  01:04:03    4     True        0   \n",
       "12         40.710907                1  19:54:00    1    False        0   \n",
       "13         40.722788                2  17:11:05    1    False        0   \n",
       "14         40.737075                1  07:22:00    2    False        0   \n",
       "15         40.728412                1  16:08:00    2    False        0   \n",
       "16         40.783357                1  14:52:00    2    False        0   \n",
       "17         40.755481                1  20:36:22    5     True        0   \n",
       "18         40.762070                1  13:18:00    1    False        0   \n",
       "19         40.758787                1  12:15:46    1    False        0   \n",
       "\n",
       "    peak_hour  hotspot      dist  \n",
       "0           1        0  1.030764  \n",
       "1           1        0  8.450134  \n",
       "2           0        1  1.389525  \n",
       "3           0        1  2.799270  \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Save Report\n",
    "saved_report.to_csv(\"/models/SVM_report.csv\", index=False)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "with open('/models/SVM_Experiment1.pkl', 'wb') as f:\n",
    "\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "with open('/models/SVM_Experiment1.pkl', 'rb') as f:\n",
    "\n",
